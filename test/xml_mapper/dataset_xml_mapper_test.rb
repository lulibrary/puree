...
class TestXMLExtractorDataset < Minitest::Test
  ...
  def xml_extractor_from_id(id)
    ...
    Puree::ModelFoo::DatasetCollection.parse response.to_s
  end
  ...
  #   puts x.inspect
  #
  #   # puts x.datasets.first.temporal.start.year
  #   # puts x.class
  #   # puts x.inspect.size
  #   # x.datasets.each { |i| puts i.title }
  #   # puts x.datasets.first.title
  # end
